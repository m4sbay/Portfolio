...
export const metadata: Metadata = {
  title: "About",
  description:
    "Tentang Masbay: Frontend Developer, UI/UX Designer, dan Digital Content Creator dari Padang.",
  openGraph: {
    title: "About — Masbay",
    description:
      "Tentang Masbay: Frontend Developer, UI/UX Designer, dan Digital Content Creator dari Padang.",
      ...
      <header className="grid grid-cols-1 gap-8 sm:grid-cols-[160px_1fr] sm:items-center">
        ...
        <div className="space-y-3">
          ...
          <p className="max-w-2xl text-base leading-7 text-zinc-600 dark:text-zinc-300">
            Aku M. Maulana Bayu (Masbay) — frontend developer, UI/UX designer, dan
            digital content creator dari Padang. Aku suka bikin interface yang
            clean, minimal, dan terasa “premium”, dengan fokus ke detail,
      ...
      <section className="space-y-4">
        ...
        <ul className="flex flex-wrap gap-2">
          {skills.map((s) => (
            <li
              key={s}
              className="rounded-full border border-zinc-200 bg-zinc-50 px-3 py-1.5 text-sm text-zinc-700 dark:border-white/10 dark:bg-white/5 dark:text-zinc-300"
            >
              {s}
            </li>
          ))}
