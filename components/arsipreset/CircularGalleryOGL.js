// CircularGalleryOGL.js
// OGL logic dipisah ke .js agar TypeScript tidak mencoba memeriksa OGL internal types.
// File ini TIDAK menggunakan "use client" — murni vanilla JS, diimport oleh CircularGallery.tsx.
...
export async function resolveFont(font, fontUrl) {
...
export class App {
  ...
  /** Tandai user sedang interaksi → pause auto-scroll sementara */
  markInteracting() {
  ...
  update() {
    // Auto-scroll lembut saat tidak ada interaksi user
