...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-[10px] border border-zinc-200/90 bg-white text-zinc-700 shadow-sm outline-none transition-[color,background-color,transform,box-shadow,border-color] duration-200 hover:-translate-y-px hover:border-zinc-300 hover:bg-zinc-50 hover:text-zinc-950 hover:shadow active:translate-y-0 dark:border-white/12 dark:bg-white/[0.07] dark:text-zinc-200 dark:hover:border-white/22 dark:hover:bg-white/12 dark:hover:text-white focus-visible:ring-2 focus-visible:ring-zinc-400/60 focus-visible:ring-offset-2 focus-visible:ring-offset-white dark:focus-visible:ring-zinc-500/50 dark:focus-visible:ring-offset-zinc-950"
